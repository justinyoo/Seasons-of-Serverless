...
In the city of Adana in Turkey, festivals are held with a competition centered around who can make the longest kebab in the world. Your task? Create a **kebab calculator** that, given a certain amount of meat in kilos, can calculate how many people you'll be able to feed as well as how long your kebab can be! [Learn more about this challenge](Dec-7-2020.md).
...
| ------------------------ | ------------------ | ------------- | ------------------------------------------------ | ---------------------------------------------------------------------------------------------------------- |
| [Dec 21](Dec-21-2020.md) | Tteok-guk for The New Year | Asia/Korea | Justin Yoo, You Jin Kim, Hong Min Kim, Aron Roh  | [Solution](https://dev.to/azure/tbd) |
